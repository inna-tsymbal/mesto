...
function createCard(titleValue, linkValue) {
  ...
  cardAll.querySelector('.card__button-like').addEventListener('click', handleLikeClick);
  cardAll.querySelector('.card__trash').addEventListener('click', handleDeleteClick);
  cardImage.addEventListener('click', () => openImagePopup(linkValue, titleValue));
